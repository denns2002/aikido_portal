...
urlpatterns = [
    ...
    path("club/<slug:slug>/archive/", ArchiveClubAPIView.as_view(), name="archive-club"),
    ...
    path("group-member-change/<slug:profile__slug>/", GroupMemberChangeAPIView.as_view(), name="group-member-change"),
]
