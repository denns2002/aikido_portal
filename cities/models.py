...
class House(models.Model):
    number = models.CharField(max_length=255, verbose_name=multilang_verb("Number", "Номер дома"))
...
class Apt(models.Model):
    number = models.CharField(max_length=255, verbose_name=multilang_verb("Number", "Номер квартиры"))
